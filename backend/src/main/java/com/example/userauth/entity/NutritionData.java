...
/**
 * NutritionData entity representing nutrition information for a fruit.
 * Contains component name and value for nutrition data.
 */
@Entity
...
public class NutritionData {
    ...
    public NutritionData(Fruit fruit, String componentName, BigDecimal componentValue) {
        this.fruit = fruit;
